...
def vocoder_overlap(signal, fs, channel_n, channel_width, channel_shape, flo, fhi):
    ...
    for cf in cfs:
        ...
        Mod_carrier = filtfilt(b_band_lp, a_band_lp, Mod_carrier)*Sig_env_sub;
        
        # Post filter
        Mod_carrier_filt = lfilter(b_ba_hp, a_out_hp, Mod_carrier);
