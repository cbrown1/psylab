...
class Subject_Manager (QtGui.QWidget, form_class):
    ...
    def __init__(self,parent=None):
        ...
        self.admin_protocols_remove_pushButton.setIcon(QtGui.QIcon(os.path.join(self.image_path,"delete.png")))
        self.admin_protocols_remove_pushButton.setText("")

        self.admin_protocols_add_pushButton.setIcon(QtGui.QIcon(os.path.join(self.image_path,"add.png")))
        ...
        self.admin_user_remove_pushButton.setIcon(QtGui.QIcon(os.path.join(self.image_path,"delete.png")))
        self.admin_user_remove_pushButton.setText("")

        self.admin_user_add_pushButton.setIcon(QtGui.QIcon(os.path.join(self.image_path,"add.png")))
        self.admin_user_add_pushButton.setText("")

        self.admin_reports_remove_pushButton.setIcon(QtGui.QIcon(os.path.join(self.image_path,"delete.png")))
        self.admin_reports_remove_pushButton.setText("")
        
        self.admin_reports_add_pushButton.setIcon(QtGui.QIcon(os.path.join(self.image_path,"add.png")))
    ...
    def admin_create_db(self, dbname=None):
        if dbname is None:
            ret = self.get_newfile(title = 'Enter new database name to create:', file_types = "SQLite DB Files (*.db);;All files (*.*)")
            if ret != '':
                dbname = ret
    ...
    def admin_protocols_add(self):
        ...
        if ret != '':
            ...
            item_a.setIcon(QtGui.QIcon(os.path.join(self.image_path,"chart_pie.png")))
    ...
    def admin_user_add(self):
        ...
        if ret != '':
            ...
            item.setIcon(QtGui.QIcon(os.path.join(self.image_path,"card.png")))
            item.setFlags( QtCore.Qt.ItemIsSelectable | QtCore.Qt.ItemIsEnabled )
            self.admin_user_listWidget.insertItem(-1, item)
