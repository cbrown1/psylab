...
def compress(sig, fs, threshold, comp_ratio, attack, release, ref_spl=110, delay_audio=False, make_up=False):
    ...
    gain_sig = np.zeros_like(d_dB)   # set gain to zero throughout as a first step.  
    ...
    gain_sig[idx] = (threshold + (d_dB[idx] - threshold) / comp_ratio) - d_dB[idx]
